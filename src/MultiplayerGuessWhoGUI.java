...
public class MultiplayerGuessWhoGUI  extends JFrame {//GuessWhoGUI
     ...
     */
    public MultiplayerGuessWhoGUI () {//constructor
        ...
        try {
            ...
            MultiplayerGuessWhoGame.setTheDeck(new Deck());
        ...
        for(CheckButton button : buttonList) {
            button.addActionListener(new MultiplayerCheckAction());
    ...
    public void guessSuspect(Suspect character) throws InterruptedException {
        ...
        if (character == MultiplayerGuessWhoGame.getGuilty()) {
            System.out.println("CORRECT!");

            showResultFrame("Game Over you win");
            ...
            if (wrongGuesses >= 3) {
                showResultFrame("Game Over you lose");
     ...
     */
    public Deck getDeck() {
        return MultiplayerGuessWhoGame.getTheDeck();
    }
    ...
    public void createSuspectGrid() {
        ...
        for (int i = 0; i < MultiplayerGuessWhoGame.getTheDeck().getTotalCards(); i++) {
            ...
            JLabel cardLabel = new JLabel(new ImageIcon(MultiplayerGuessWhoGame.getTheDeck().getSuspect(i).getCard().getFrontImage()));
            cardLabel.setBounds(xPosition, yPosition, cardLabelWidth, cardLabelHeight);
            cardLabel.setIcon(new ImageIcon(MultiplayerGuessWhoGame.getTheDeck().getSuspect(i).getCard().getFrontImage()));
            ...
            cardLabel.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    System.out.println("Clicked on suspect: " + MultiplayerGuessWhoGame.getTheDeck().getSuspect(index).getAttribute("name"));


                    try {
                        guessSuspect(MultiplayerGuessWhoGame.getTheDeck().getSuspect(index));
    ...
    public void flipCard(int index) {
        ...
        cardLabel.setIcon(new ImageIcon(MultiplayerGuessWhoGame.getTheDeck().getSuspect(index).getCard().getBackImage()));
    }
    ...
    private void playerCardFrameStuff(){
        ...
        ImageIcon cardIcon = new ImageIcon(MultiplayerGuessWhoGame.getPlayerCharacter().getCard().getFrontImage());
    ...
    private void assignGuiltySuspect(){
        ...
        int x = (int) (Math.random() * MultiplayerGuessWhoGame.getTheDeck().getTotalCards());
        System.out.println(MultiplayerGuessWhoGame.getTheDeck().getSuspect(x).getAttribute("name"));
        MultiplayerGuessWhoGame.setGuilty(MultiplayerGuessWhoGame.getTheDeck().getSuspect(x));

        int randomPlayerCharacter = (int) (Math.random() * MultiplayerGuessWhoGame.getTheDeck().getTotalCards());
        MultiplayerGuessWhoGame.setPlayerCharacter(MultiplayerGuessWhoGame.getTheDeck().getSuspect(randomPlayerCharacter));
    }
